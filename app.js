...
const cssClasses = {
  ...
  done:"bg-white w-full text-center text-yellow-500 rounded py-4 border-2 border-yellow-500 transition transform ease-in-out duration-300 hover:bg-yellow-500 hover:text-white hover:scale-110 hover:-rotate-1 cursor-pointer"
};
